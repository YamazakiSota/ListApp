...
#ifndef LISTAPP_SWIFT_H
#define LISTAPP_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="ListApp",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS("_TtC7ListApp17AddViewController")
@interface AddViewController : FormViewController
- (void)viewDidLoad;
- (IBAction)toukouButton;
...
SWIFT_CLASS("_TtC7ListApp11AppDelegate")
...
SWIFT_CLASS("_TtC7ListApp20DetailViewController")
...
SWIFT_CLASS("_TtC7ListApp13SceneDelegate")
...
SWIFT_CLASS("_TtC7ListApp14ViewController")
@interface ViewController : UIViewController <UITableViewDataSource, UITableViewDelegate>
@property (nonatomic, weak) IBOutlet UITableView * _Null_unspecified tableview;
- (void)viewDidLoad;
- (IBAction)addBtnAction:(id _Nonnull)sender;
